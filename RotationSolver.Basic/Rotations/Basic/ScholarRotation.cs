...
public partial class ScholarRotation
{
	...
	{
		setting.ActionCheck = () => DataCenter.HasPet() && !FairyDismissed && InRangeOfPet(20) > 0;
		setting.IsFriendly = true;
		setting.CreateConfig = () => new ActionConfig()
		{
			AoeCount = 1,
	...
	{
		setting.ActionCheck = () => SeraphTime <= 0 && DataCenter.HasPet() && !FairyDismissed && InRangeOfPet(20) > 0;
		setting.IsFriendly = true;
	}
